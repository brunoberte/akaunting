...
export interface RevenueFormState {
    values: Partial<Omit<RevenueModel, 'id'>>;
    errors: Partial<Record<keyof RevenueFormState['values'], string>>;
}
...
export default function RevenueForm({
    ...
    const { data, setData, patch, post, errors, processing, recentlySuccessful } = useForm<Required<RevenueModel>>({
        id: revenue.id || null,
        account_id: revenue.account_id || null,
        paid_at: revenue.paid_at || null,
        amount: revenue.amount || null,
        currency_code: revenue.currency_code || null,
        customer_id: revenue.customer_id || null,
        description: revenue.description || null,
        category_id: revenue.category_id || null,
        reference: revenue.reference || null,
    });
    ...
    const pageTitle = data.id ? 'Edit Revenue' : 'Add new Revenue';
